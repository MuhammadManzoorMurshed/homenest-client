    ...
    return (
        <section className='relative'>
            ...
            <div className='absolute top-1/2 -translate-y-1/2 sm:left-10 sm:w-3/5 md:left-20 md:w-1/2 lg:w-3/7 [@media(min-width:28rem)]:px-10 [@media(min-width:35rem)]:px-15 [@media(min-width:40rem)]:px-0'>
                <h1 className='font-semibold sm:font-bold font-fredoka text-2xl [@media(min-width:28rem)]:text-3xl [@media(min-width:40rem)]:text-5xl [@media(min-width:64rem)]:text-7xl text-white text-center sm:text-left'><span className='text-[#02c8a7]'>Find</span> Your<span><br /></span>Dream <span className='text-[#02c8a7]'>House</span></h1>
