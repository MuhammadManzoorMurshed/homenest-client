    ...
    return (
        <section className='my-10 bg-white p-5 rounded-md flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4'>
            <div className='relative sm:flex-1 lg:flex-2'>
                <input onChange={handleSearch} type="text" placeholder='Example: 2 bed apartment' className='w-full border border-gray-300 rounded-md py-2 px-8 focus:outline-none focus:ring-1 focus:ring-teal-500 placeholder:text-xs' />
            ...
            <div className='sm:flex-2 md:flex-1 flex flex-col [@media(min-width:28rem)]:flex-row [@media(min-width:28rem)]:justify-between [@media(min-width:28rem)]:items-center gap-4 [@media(min-width:28rem)]:gap-2'>
                <div className='flex-1 [@media(min-width:28rem)]:flex-2 relative'>
                    <select onChange={handleSort} name="sort" id="sort" className='w-full bg-teal-100 flex-1 border border-gray-300 rounded-md py-2 px-4 focus:outline-none focus:ring-1 focus:ring-teal-500 appearance-none'>
