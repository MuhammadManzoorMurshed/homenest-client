...
const RatingCard = () => {
    return (
        <div className='group h-125 sm:h-60 sm:flex sm:justify-between sm:items-center gap-5 bg-white rounded-lg overflow-hidden shadow-xs sm:pr-5'>
            <img className='group-hover:scale-105 transition-transform duration-300 flex-1 h-1/2 w-full object-cover sm:size-full block sm:hidden' src="/2.png" alt="" />
            <div className='flex-2 px-3 py-5'>
                
                <div className='flex justify-start items-end gap-6'>
                    <img className='group-hover:scale-105 transition-transform duration-300  h-24 w-32 object-cover rounded-lg hidden sm:block' src="/2.png" alt="" />
                    <div>
