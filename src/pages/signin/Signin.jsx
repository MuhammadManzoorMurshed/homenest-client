    ...
    return (
        <div className='card my-15 bg-teal-100 dark:bg-gray-800 dark:text-gray-200 sm:w-150 md:w-175 sm:mx-auto sm:px-6 py-10'>
            ...
            <div className='card-body px-4'>
                ...
                transition={transitions.fast}
                type='button'
                onClick={() => handleSignInWithGoogle()} className="btn py-6 mt-6 mx-auto bg-white dark:bg-gray-700 text-black dark:text-white border-[#e5e5e5] dark:border-gray-600 w-full">
