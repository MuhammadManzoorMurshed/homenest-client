    ...
    return (
        <div className='max-w-7xl mx-auto my-15'>
            ...
            <div className='text-right'>
                ...
                >
                    Manage your active listings, monitor inquiries, and keep your property details<span className='hidden sm:inline'><br /></span>up to date for potential buyers and renters.
                </MotionParagraph>
            </div>
